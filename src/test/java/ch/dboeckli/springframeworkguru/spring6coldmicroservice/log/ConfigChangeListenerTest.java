package ch.dboeckli.springframeworkguru.spring6coldmicroservice.log;
...
class ConfigChangeListenerTest {
    ...
    private static final String LOGGER_NAME = "ch.dboeckli.springframeworkguru.spring6coldmicroservice.log.ConfigChangeListener";
