package ch.dboeckli.springframeworkguru.spring6coldmicroservice.config;
...
import static ch.dboeckli.springframeworkguru.spring6coldmicroservice.listener.DrinkRequestListener.GROUP_ID;
    ...
    void shouldHaveRequiredTopics() throws Exception {
        try (AdminClient adminClient = AdminClient.create(kafkaAdmin.getConfigurationProperties())) {
            ...
            assertThat(topics)
                ...
                .contains(
                    KafkaConfig.DRINK_REQUEST_COLD_TOPIC
                );
